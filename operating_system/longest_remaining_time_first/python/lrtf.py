...
def findlargest(at): 
    ...
    # returning the index of the process having the largest BT return max
...
if __name__ =="__main__": 
    ...
    for i in range(4):  
        ...
        # assigning 2, 4, 6, 8 as Burst Time to the processes backup for displaying the output in last calculating total required time for terminating the function().  
        p[i][2] = 2 * (i + 1)  
        p[i][3] = p[i][2]  
        prefinaltotal += p[i][2]  
