...
function josephusProblem($n, $k): int
 {
     if($n === 1)
     {
         return 1;
 ...
 echo sprintf("n=5, k=2, safe position=%d", josephusProblem(5, 2)) . PHP_EOL;
 echo sprintf("n=7, k=3, safe position=%d", josephusProblem(7, 3));